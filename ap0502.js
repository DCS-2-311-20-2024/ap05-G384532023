...
function init() {
  ...
  // 関数の適用
  // 最上段
  setUvs( 0, 1, 1); setUvs( 1, 3, 1); setUvs( 2, 5, 1);  
  setUvs( 3, 7, 1); setUvs( 4, 9, 1);
  // 2段目
  setUvs( 6, 1, 2); setUvs( 5, 3, 2); setUvs( 9, 5, 2);  
  setUvs( 8, 7, 2); setUvs( 7, 9, 2);
  // 3段目
  setUvs( 16, 2, 3); setUvs( 15, 4, 3); setUvs( 19, 6, 3);  
  setUvs( 18, 8, 3); setUvs( 17, 10, 3);
  
  // 最下段
  setUvs( 11, 2, 4); setUvs( 10, 4, 4); setUvs( 14, 6, 4);  
  setUvs( 13, 8, 4); setUvs( 12, 10, 4);
  ...
  function render() {
    ...
    // テクスチャの切り替え
    material.map = controls.test ? testTexture : moonTexture;
